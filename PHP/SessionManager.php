<?php
// PHP/SessionManager.php
// Wrapper کلاس قدیمی جهت حفظ سازگاری کامل با کدهای دیگر پروژه و کاهش افزونگی
...
class SessionManager {
    ...
    public function createSession($username, $deviceId, $deviceModel, $androidVersion, $ipAddress, $userType = null, $appVersion = null) {
        return $this->service->createMobileSession(
            (string)$username,
            (string)$deviceId,
            (string)$deviceModel,
            ...
            $appVersion ? (string)$appVersion : null
        );
    }
