<?php
// PHP/Monitoring/index.php
//
// داشبورد مانیتورینگ — رندر سمت سرور، پشت گیت نشست (DEEP_CODE_AUDIT.md فاز۳ #۳۲ فاز ب).
// جایگزین pull-based هشدار Telegram (که روی سرور بدون دسترسی خروجی به اینترنت
// اصلاً کار نمی‌کرد، فاز الف همین مورد را ببینید) — این صفحه هر ۳۰ ثانیه از
// api.php بازخوانی می‌کند تا هشدارهای رویدادهای امنیتی/health-check دیده شوند.
