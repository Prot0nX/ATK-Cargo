/* =============================================================================
   داشبورد مانیتورینگ — جاوااسکریپت (وانیلا، بدون وابستگی، هم‌الگو با Lic/assets/app.js)
   =============================================================================
   برخلاف Lic (که بازخوانی خودکار را عمداً حذف کرده بود)، این داشبورد هر ۳۰
   ثانیه خودکار بازخوانی می‌کند — کل هدف فاز الف (DEEP_CODE_AUDIT.md #۳۲) یک
   مدل pull-based بود، پس بازخوانی دوره‌ای اینجا یک ویژگی است نه نشتی نشست.
   ========================================================================== */
