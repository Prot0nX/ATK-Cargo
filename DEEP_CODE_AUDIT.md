...
| 4.3 | ⚠️ شروع شد (Phase 5.10) — فقط `feature:auth` (اولین ماژول feature، طبق پیشنهاد خودِ گزارش «به‌عنوان الگو» چون از قبل ساختارش تمیز بود) استخراج شد؛ ۱۱ feature باقی‌مانده هنوز در `app` هستند. جزئیات و مانع معماری کشف‌شده در پایین | High |
