...
| 4.10 | ⚠️ چک‌لیست به تست عملی روی throwaway DB محلی ارتقا یافت (Phase 5.15) — یک ریسک واقعی کشف شد (بدون سقف طول روی فیلدهای متنی آزاد). هنوز فعال‌سازی نهایی روی production انجام نشده و منتظر تأیید/گام ۱ (اسکن داده‌ی واقعی) از سمت کاربر است. جزئیات در `PHP/STRICT_MODE_CHECKLIST.md` | Medium |
