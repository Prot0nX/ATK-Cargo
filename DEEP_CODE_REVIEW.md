...
| # | اقدام | Effort |
|---|-------|--------|
| ۲۹ | ✅ انتقال بقیه featureها به ماژول مستقل (feature:cargo، feature:reports، feature:update انجام شد — ۵ feature دیگر باقی مانده: home، cargo_entry، cargo_registration، cargo_counter، cargo_details) | High |
