...
### Community 19 - "QuotasListScreen.kt"
Cohesion: 0.19
...
### Community 24 - "ShipInfoSection.kt"
Cohesion: 0.16
...
### Community 46 - "ReportsViewModel.kt"
Cohesion: 0.15
...
### Community 55 - "RetrofitClient.kt"
Cohesion: 0.21
...
### Community 87 - "ColorSelector"
Cohesion: 0.39
Nodes (3): adjustColorForTheme(), ColorSelector, Color

### Community 88 - "ShipSortingMode"
Cohesion: 0.25
...
### Community 113 - "EmptyState.kt"
Cohesion: 0.83
Nodes (3): EmptyState(), ImageVector, Modifier

### Community 128 - "ViewMode"
Cohesion: 0.67
Nodes (3): ViewMode, FLAT, GROUPED

## Knowledge Gaps
- **109 isolated node(s):** `SplashScreenConstants`, `Idle`, `ErrorResponse`, `RequestBatteryOptimization`, `ChatMessagesResponse` (+104 more)
...
- **Why does `validateServerSession()` connect `CargoDetailsScreen.kt` to `CargoCounterScreen.kt`, `ManageReportsScreen.kt`, `Exception`, `StartupViewModel`, `SelectInfoScreen.kt`?**
  _High betweenness centrality (0.086) - this node is a cross-community bridge._
- **Why does `ReportsViewModel` connect `ReportsViewModel` to `InitialInfoScreen.kt`, `ReportModels.kt`, `UpdateManager`, `LoadingState`, `ManageReportsScreen.kt`, `WarehouseQuotaGroupingMode`, `Exception`, `QuotaAnalysisSection.kt`, `ReportsViewModel.kt`, `StartupViewModel`, `SelectInfoScreen.kt`, `QuotasListScreen.kt`, `ColorSelector`, `ShipSortingMode`, `AppModule.kt`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `confirmCargo()` connect `CargoDetailsScreen.kt` to `CargoInfo`, `Exception`?**
  _High betweenness centrality (0.044) - this node is a cross-community bridge._
- **What connects `SplashScreenConstants`, `Idle`, `ErrorResponse` to the rest of the system?**
