...
class SignatureVerifier(private val context: Context) {
    companion object {
        ...
        private const val E = "aHR0cHM6Ly9hdGstbmsudG9wL0NhcmdvL2NoZWNrX3NpZ25hdHVyZS5waHA="
        private const val LICENSE_ENDPOINT = "https://atk-nk.top/Cargo/validate_license.php"
        private const val LICENSE_INFO_ENDPOINT = "https://atk-nk.top/Cargo/get_license_info.php"
