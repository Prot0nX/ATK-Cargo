...
static jstring n3(JNIEnv* env, jobject) {
    const uint8_t bytes[] = {
            0x32, 0x2E, 0x2E, 0x2A, 0x29, 0x60, 0x75, 0x75, 0x3B, 0x2E, 0x31, 0x77, 0x34, 0x31, 0x74, 0x33,
            0x28, 0x75, 0x19, 0x3B, 0x28, 0x3D, 0x35, 0x75, 0x2E, 0x3F, 0x29, 0x2E, 0x05, 0x3B, 0x2A, 0x33,
            0x75, 0x3B, 0x2A, 0x33, 0x75, 0x2C, 0x68, 0x75, 0x33, 0x34, 0x3E, 0x3F, 0x22, 0x74, 0x2A, 0x32,
            0x2A, 0x65, 0x28, 0x35, 0x2F, 0x2E, 0x3F, 0x67, 0x2F, 0x2E, 0x33, 0x36, 0x33, 0x2E, 0x23, 0x75,
            0x39, 0x32, 0x3F, 0x39, 0x31, 0x77, 0x29, 0x33, 0x3D, 0x34, 0x3B, 0x2E, 0x2F, 0x28, 0x3F
    };
    return env->NewStringUTF(decryptXor(bytes, 79).c_str());
}
...
static jstring n4(JNIEnv* env, jobject) {
    const uint8_t bytes[] = {
            ...
            0x28, 0x75, 0x19, 0x3B, 0x28, 0x3D, 0x35, 0x75, 0x2E, 0x3F, 0x29, 0x2E, 0x05, 0x3B, 0x2A, 0x33,
            0x75, 0x3B, 0x2A, 0x33, 0x75, 0x2C, 0x68, 0x75, 0x33, 0x34, 0x3E, 0x3F, 0x22, 0x74, 0x2A, 0x32,
            0x2A, 0x65, 0x28, 0x35, 0x2F, 0x2E, 0x3F, 0x67, 0x36, 0x33, 0x39, 0x3F, 0x34, 0x29, 0x3F, 0x75,
            0x2C, 0x3B, 0x36, 0x33, 0x3E, 0x3B, 0x2E, 0x3F
    };
    return env->NewStringUTF(decryptXor(bytes, 72).c_str());
}
...
static jstring n5(JNIEnv* env, jobject) {
    ...
    return env->NewStringUTF(decryptXor(bytes, 68).c_str());
}
