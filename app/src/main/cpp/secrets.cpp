...
Java_com_atk_atk_1cargo_api_Secrets_getBaseUrl(JNIEnv* env, jobject /* this */) {
    ...
    const uint8_t bytes[] = {
            ...
            0x28, 0x75, 0x19, 0x3B, 0x28, 0x3D, 0x35, 0x75
    };
    return env->NewStringUTF(decryptXor(bytes, 24).c_str());
}
...
Java_com_atk_atk_1cargo_api_Secrets_getExpectedSignatureHash(JNIEnv* env, jobject /* this */) {
    // Original: "6a6e02dce2d2286ec2211cc9f20fc0dfe8c9e2ef5663e1584e7aa3bfc5e09471"
    const uint8_t bytes[] = {
            0x6C, 0x3B, 0x6C, 0x3F, 0x6A, 0x68, 0x3E, 0x39, 0x3F, 0x68, 0x3E, 0x68, 0x68, 0x62, 0x6C, 0x3F,
            0x39, 0x68, 0x68, 0x6B, 0x6B, 0x39, 0x39, 0x63, 0x3C, 0x68, 0x6A, 0x3C, 0x39, 0x6A, 0x3E, 0x3C,
            0x3F, 0x62, 0x39, 0x63, 0x3F, 0x68, 0x3F, 0x3C, 0x6F, 0x6C, 0x6C, 0x69, 0x3F, 0x6B, 0x6F, 0x62,
            0x6E, 0x3F, 0x6D, 0x3B, 0x3B, 0x69, 0x38, 0x3C, 0x39, 0x6F, 0x3F, 0x6A, 0x63, 0x6E, 0x6D, 0x6B
    };
    return env->NewStringUTF(decryptXor(bytes, 64).c_str());
}
...
Java_com_atk_atk_1cargo_api_Secrets_getSignatureCheckUrl(JNIEnv* env, jobject /* this */) {
    // Original: "https://atk-nk.ir/Cargo/check_signature.php"
    const uint8_t bytes[] = {
            0x32, 0x2E, 0x2E, 0x2A, 0x29, 0x60, 0x75, 0x75, 0x3B, 0x2E, 0x31, 0x77, 0x34, 0x31, 0x74, 0x33,
            0x28, 0x75, 0x19, 0x3B, 0x28, 0x3D, 0x35, 0x75, 0x39, 0x32, 0x3F, 0x39, 0x31, 0x05, 0x29, 0x33,
            0x3D, 0x34, 0x3B, 0x2E, 0x2F, 0x28, 0x3F, 0x74, 0x2A, 0x32, 0x2A
    };
    return env->NewStringUTF(decryptXor(bytes, 43).c_str());
}

JNIEXPORT jstring JNICALL
Java_com_atk_atk_1cargo_api_Secrets_getLicenseCheckUrl(JNIEnv* env, jobject /* this */) {
    // Original: "https://atk-nk.ir/Cargo/validate_license.php"
    const uint8_t bytes[] = {
            0x32, 0x2E, 0x2E, 0x2A, 0x29, 0x60, 0x75, 0x75, 0x3B, 0x2E, 0x31, 0x77, 0x34, 0x31, 0x74, 0x33,
            0x28, 0x75, 0x19, 0x3B, 0x28, 0x3D, 0x35, 0x75, 0x2C, 0x3B, 0x36, 0x33, 0x3E, 0x3B, 0x2E, 0x3F,
            0x05, 0x36, 0x33, 0x39, 0x3F, 0x34, 0x29, 0x3F, 0x74, 0x2A, 0x32, 0x2A
    };
    return env->NewStringUTF(decryptXor(bytes, 44).c_str());
}

JNIEXPORT jstring JNICALL
Java_com_atk_atk_1cargo_api_Secrets_getLicenseInfoUrl(JNIEnv* env, jobject /* this */) {
    // Original: "https://atk-nk.ir/Cargo/get_license_info.php"
    const uint8_t bytes[] = {
            0x32, 0x2E, 0x2E, 0x2A, 0x29, 0x60, 0x75, 0x75, 0x3B, 0x2E, 0x31, 0x77, 0x34, 0x31, 0x74, 0x33,
            0x28, 0x75, 0x19, 0x3B, 0x28, 0x3D, 0x35, 0x75, 0x3D, 0x3F, 0x2E, 0x05, 0x36, 0x33, 0x39, 0x3F,
            0x34, 0x29, 0x3F, 0x05, 0x33, 0x34, 0x3C, 0x35, 0x74, 0x2A, 0x32, 0x2A
    };
    return env->NewStringUTF(decryptXor(bytes, 44).c_str());
}
